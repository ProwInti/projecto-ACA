...
/*
	...
	Cod_Car		CÛdigo Cargo
	Des_Car		DescripciÛn de Cargo	
*/
...
/*
	...
	Cod_Prof	CÛdigo ProfesiÛn
	Des_Prof	DescripciÛn ProfesiÛn
*/
...
IF (GETDATE()) > (select Hora_Delay_registro from REGISTRO where Codigo_Registro = (select MAX(Codigo_Registro)from REGISTRO where Rut_Funcionario = '16223134'))select 'TRUE'else select 'FALSE'go
select Tipo_Registro from REGISTRO where Codigo_Registro = (select MAX(Codigo_Registro)from REGISTRO where Rut_Funcionario = '16223134')

select * from registro
select Rut_Funcionario, DigitoV_Funcionario from FUNCIONARIO where Rut_Funcionario ='16223134'
select Nombre_Funcionario, ApellidoP_Funcionario, ApellidoM_Funcionario  from FUNCIONARIO where Rut_Funcionario = '16223134'
...
select * from REGISTRO where Rut_Funcionario = '16223134' and DigitoV_Funcionario = '0'
...
select 	f.Codigo_Funcionario, f.Rut_Funcionario, DigitoV_Funcionario,f.ApellidoP_Funcionario,f.ApellidoM_Funcionario,
		f.Nombre_Funcionario,f.Sexo_Funcionairo,f.Fecha_Nacimiento_Funcionario,f.Telefono_Funcionario,f.Celular_Funcionario,
		f.Correo_Funcionario,p.Descripcion,c.Descripcion,f.Departamento_Funcionario,f.Ciclo_Funcionario,
		f.Horario_Asignado_Funcionario,f.Estado_Funcionario 
from FUNCIONARIO f,CARGO c, PROFESION p where p.Codigo_Profesion = f.Profesion_Funcionario and c.Codigo_Cargo = f.Cargo_Funcionario


select * from FUNCIONARIO where rut_Funcionario = '16223134'
select * from FUNCIONARIO where  nombre_Funcionario like '%jose%' 
drop table REGISTRO

select Codigo_Funcionario from FUNCIONARIO where Rut_Funcionario = '16223134'
...
insert into CARGO values (22,'DISE—ADORA')
...
insert into PROFESION values(125,'DESI—O INDUSTRIAL')
insert into PROFESION values(216,'DIBUJANTE ARQUITECTONICO')
insert into PROFESION values(120,'DIRECCION YPROD.CINE Y T.V.')
insert into PROFESION values(174,'DISE—ADOR')
insert into PROFESION values(96,'DISEÒADOR GRAFICO')
insert into PROFESION values(24,'DISEÒADORA')
insert into PROFESION values(186,'DISE—ADORA VESTUARIO MENCION TEXTIL')
insert into PROFESION values(187,'DISE—O INDUSTRIAL')
insert into PROFESION values(210,'DISE—O INDUSTRIAL')
insert into PROFESION values(212,'DISE—O INDUSTRIAL')
insert into PROFESION values(246,'DISE—O INDUSTRIAL')
insert into PROFESION values(30,'DUEÒA DE CASA')
...
insert into PROFESION values(238,'TECNICO EN BIBLIOTECOLOGÕA')
...
insert into FUNCIONARIO values (16,'10154302','1','CA—AS','OSMER','ANDREA PILAR','F','1967-10-08',585211,62087189,null,21,5,null,null,null,'A')
...
insert into FUNCIONARIO values (25,'7961343','6','GALLEGOS','NU—EZ','MANUEL','M','1958-03-12',280228,93570883,null,13,1,null,null,null,'A')
...
insert into FUNCIONARIO values (45,'8583582','3','OLEA','NU—EZ','CLAUDIO','M','1961-09-08',245298,98443373,null,13,2,null,null,null,'A')
...
insert into FUNCIONARIO values (86,'10094991','1','MU—OZ','ARANCIBIA','MARCIA','F','1964-08-27',219230,98718457,null,13,2,null,null,null,'A')
...
insert into FUNCIONARIO values (209,'7231709','2','VEGA','MU—OZ','WILLIAM H.','M','1955-09-26',412055,89582793,null,13,1,null,null,null,'A')
...
insert into FUNCIONARIO values (234,'14200587','5','BERTOLONE','BRICE—O','ROSELLA G.','F','1981-02-12',281157,0,null,13,2,null,null,null,'A')
...
insert into FUNCIONARIO values (248,'8636981','8','NU—EZ','GONZALEZ','ANA L.','F','1964-10-04',755170,0,null,21,6,null,null,null,'A')
...
insert into FUNCIONARIO values (293,'8508466','6','DE BAEREMAECKER','MU—OZ','MADELEINE ASTRID','F','1960-07-21',73377730,73377730,null,13,5,null,null,null,'A')
insert into FUNCIONARIO values (294,'14427127','0','MU—OZ','ROMAN','ALVARO VLADIMIR','M','1974-05-01',91458570,0,null,13,7,null,null,null,'A')
...
insert into FUNCIONARIO values (303,'11015559','K','PAVEZ','PE—A','MARIA JUSTINA','F','1965-07-10',85451928,0,null,129,18,null,null,null,'A')
...
insert into FUNCIONARIO values (334,'13500861','3','ARAVENA','CARRE—O','EDMUNDO ANDRES','M','1978-01-27',22222222,63061142,null,13,1,null,null,null,'A')
...
insert into FUNCIONARIO values (348,'8303934','5','SALAZAR','IBA—EZ','LILIANA DE JESUS','F','1960-12-31',72222233,83248906,null,999,29,null,null,null,'A')
...
insert into FUNCIONARIO values (353,'13343647','2','ROMAN','ZU—IGA','MARCELA DEL CARMEN','F','1978-07-28',22220352,78246886,null,244,18,null,null,null,'A')
...
insert into FUNCIONARIO values (358,'12515067','5','ZU—IGA','GONZALEZ','INGRID DEL CARMEN','F','1972-12-24',2319963,86128392,null,129,18,null,null,null,'A')
...
insert into FUNCIONARIO values (369,'17138652','7','YA—EZ','POBLETE','NATALY NICOLE','F','1989-08-01',97137027,97137027,null,247,36,null,null,null,'A')
