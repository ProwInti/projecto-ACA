...
public class ImprimirTiket implements Printable{
    ...
    public int print(Graphics g, PageFormat pf, int pageIndex) throws PrinterException {
        ...
        g.drawString(String.valueOf(tl), 39, 20);
        
        if(tp.equals("ENTRADA")){
            g.setFont(new Font("Arial Narrow", Font.PLAIN, 13));
            g.drawString(String.valueOf(tp), 87, 36);
        }else{
            g.setFont(new Font("Arial Narrow", Font.PLAIN, 13));
            g.drawString(String.valueOf(tp), 80, 36);
        }
        
        g.setFont(new Font("Arial Narrow", Font.PLAIN, 12));
        g.drawString(String.valueOf("Nombre: "+nb), 0, 50);
        g.drawString(String.valueOf("Fecha:  "+fc), 0, 62);
        g.drawString(String.valueOf("Hora:   "+hr), 0, 75);
